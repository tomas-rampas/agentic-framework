...
model: sonnet
mcpServers: [serena, context7, sequential-thinking, filesystem, code-review-graph]
effort: high
tools: Bash, PowerShell, Glob, Grep, Read, Write, Edit, NotebookEdit, WebFetch, WebSearch, ToolSearch, Skill, Agent, Monitor, TaskCreate, TaskGet, TaskList, TaskUpdate, TaskOutput, mcp__context7__query-docs, mcp__context7__resolve-library-id, mcp__sequential-thinking__sequentialthinking, mcp__filesystem__read_text_file, mcp__filesystem__read_multiple_files, mcp__filesystem__list_directory, mcp__filesystem__search_files, mcp__filesystem__get_file_info, mcp__filesystem__directory_tree, mcp__serena__find_symbol, mcp__serena__find_declaration, mcp__serena__find_implementations, mcp__serena__find_referencing_symbols, mcp__serena__get_symbols_overview, mcp__serena__get_diagnostics_for_file, mcp__serena__search_for_pattern, mcp__serena__find_file, mcp__serena__list_dir, mcp__serena__read_file, mcp__serena__replace_symbol_body, mcp__serena__insert_after_symbol, mcp__serena__insert_before_symbol, mcp__serena__rename_symbol, mcp__serena__replace_content, mcp__serena__replace_in_files, mcp__serena__safe_delete_symbol, mcp__serena__create_text_file, mcp__serena__activate_project, mcp__serena__initial_instructions, mcp__code-review-graph, mcp__plugin_agentic-framework_context7__query-docs, mcp__plugin_agentic-framework_context7__resolve-library-id, mcp__plugin_agentic-framework_sequential-thinking__sequentialthinking, mcp__plugin_agentic-framework_filesystem__read_text_file, mcp__plugin_agentic-framework_filesystem__read_multiple_files, mcp__plugin_agentic-framework_filesystem__list_directory, mcp__plugin_agentic-framework_filesystem__search_files, mcp__plugin_agentic-framework_filesystem__get_file_info, mcp__plugin_agentic-framework_filesystem__directory_tree, mcp__plugin_agentic-framework_serena__find_symbol, mcp__plugin_agentic-framework_serena__find_declaration, mcp__plugin_agentic-framework_serena__find_implementations, mcp__plugin_agentic-framework_serena__find_referencing_symbols, mcp__plugin_agentic-framework_serena__get_symbols_overview, mcp__plugin_agentic-framework_serena__get_diagnostics_for_file, mcp__plugin_agentic-framework_serena__search_for_pattern, mcp__plugin_agentic-framework_serena__find_file, mcp__plugin_agentic-framework_serena__list_dir, mcp__plugin_agentic-framework_serena__read_file, mcp__plugin_agentic-framework_serena__replace_symbol_body, mcp__plugin_agentic-framework_serena__insert_after_symbol, mcp__plugin_agentic-framework_serena__insert_before_symbol, mcp__plugin_agentic-framework_serena__rename_symbol, mcp__plugin_agentic-framework_serena__replace_content, mcp__plugin_agentic-framework_serena__replace_in_files, mcp__plugin_agentic-framework_serena__safe_delete_symbol, mcp__plugin_agentic-framework_serena__create_text_file, mcp__plugin_agentic-framework_serena__activate_project, mcp__plugin_agentic-framework_serena__initial_instructions, mcp__plugin_agentic-framework_code-review-graph
color: green
---
